  ...
  return (
    <div className="border-b border-neutral-900 mb-24">
      ...
      <div className="flex flex-col  mx-40 mb-4 max-sm:mx-16">
        <p className="text-2xl mb-2">1. Crop Rate prediction -Machine Learning</p>
        <p className="mx-8">
      ...
      <div className="flex flex-col mx-40 mb-4 max-sm:mx-16">
        <p className="text-2xl mb-2">2. Ecommerce Website for funrniture Mall- Web Development</p>
        <p className="mx-8">
        Develop a website for furniture mall. providing a solution for showcasing the product and delivering the product.
        </p>
      </div>
      <div className="flex flex-col mx-40 mb-4 max-sm:mx-16">
        <p className="text-2xl mb-2">3. ERP System for school Management system</p>
        <p className="mx-8">
